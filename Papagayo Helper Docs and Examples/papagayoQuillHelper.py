...
#dict that shows how the will be stored in the frames in Quill.
#Creators MUST use this frame order for the tool to work properly.
mouth_order = {
    "AI": 0,
    "E": 1,
    "O": 2,
...
def main():
    ...
    mouth = input("\nPlease type the name of the paint layer (capitalization matters!) that includes the ordered, 10 mouthshapes. If you leave this blank, it will default to MyMouth.\n")
    if mouth == "":
        mouth = "MyMouth"
